...
display.fill(WHITE)
DrawText(font8, version, 5, 5, BLACK, WHITE, 0, 0)
DrawText(font16, "Picomon", 120, 110, BLACK, WHITE, 0.5, 0.5)
DrawText(font8, "Press A to Start", 120, 148, BLACK, WHITE, 0.5, 0.5)
DrawText(font8, "by Henry Gurney", 120, 235, BLACK, WHITE, 0.5, 1)
